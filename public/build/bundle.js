...
var app = (function () {
    ...
    const file = "src/Nomination.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*name*/ 1) nomination_changes.name = /*name*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ name, Nomination });
